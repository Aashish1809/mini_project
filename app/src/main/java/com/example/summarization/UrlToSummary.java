...
public class UrlToSummary extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_url_to_summary);
        ...
        findViewById(R.id.imdb_submit_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getApplicationContext(),"Provide valid URL",Toast.LENGTH_SHORT).show();
                }
                else if(mEditText.getText()!=null)
                {
                    URL_string = mEditText.getText().toString();
                }
            }
        });
